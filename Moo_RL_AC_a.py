...
action_shape = (SCH_Test_Setting.x_bin_num, 2 * x_dim )
...
def train_iteration(
    ...
    # 确保优化器已经构建
    # if not hasattr(optimizer, 'built') or not optimizer.built:
        # optimizer.build(actor_model.trainable_variables + critic_model.trainable_variables)

    dummy_input = tf.expand_dims(state_curr, 0)
